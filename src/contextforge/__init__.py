...
_LAZY_EXPORTS = {
    ...
    "ContextPlanningMode": "contextforge.intelligence",
    ...
    "EvidencePlan": "contextforge.intelligence",
    "PlannedEvidence": "contextforge.intelligence",
    "PlanningDiagnostics": "contextforge.intelligence",
