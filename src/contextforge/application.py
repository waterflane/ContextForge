...
async def build_repository_index(
    ...
    *,
    ...
    semantic_scope: SemanticScope = "priority",
    semantic_max_requests: int = 96,
    semantic_max_input_tokens: int = 256_000,
    semantic_max_chunks_per_file: int = 4,
...
async def _build_repository_index(
    ...
    *,
    ...
    semantic_max_input_tokens: int,
    semantic_max_chunks_per_file: int,
        ...
        try:
            ...
            semantic = await build_semantic_card_index(
                ...
                options=SemanticCardOptions(
                    ...
                    max_requests=semantic_max_requests,
                    max_estimated_input_tokens=semantic_max_input_tokens,
